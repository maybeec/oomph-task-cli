 ...
 * </p>
 * <ul>
 * <li>{@link com.github.maybeec.oomph.task.cli.impl.cliTaskImpl#getDirectory <em>Directory</em>}</li>
...
public class cliTaskImpl extends SetupTaskImpl implements cliTask {
    ...
    /**
     * The default value of the '{@link #getCommand() <em>Command</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getCommand()
     * @generated
     * @ordered
    ...
    /**
     * The cached value of the '{@link #getArgument() <em>Argument</em>}' attribute list. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * @see #getArgument()
     * @generated
     * @ordered
    ...
    public void setDirectory(String newDirectory) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, cliPackage.CLI_TASK__DIRECTORY,
    ...
    public void setCommand(String newCommand) {
        ...
        command = newCommand;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, cliPackage.CLI_TASK__COMMAND, oldCommand,
                command));
        }
    }
    ...
    public void setPriority(int newPriority) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, cliPackage.CLI_TASK__PRIORITY, oldPriority,
                priority));
        }
    }
    ...
    public void perform(SetupTaskContext context) throws Exception {
        ...
        CommandLineUtilImpl.getInstance().execute(directory, command, argument);
    }
