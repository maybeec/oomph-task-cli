...
public interface cliPackage extends EPackage
{
   ...
   * @generated
   */
  cliPackage eINSTANCE = cli.impl.cliPackageImpl.init();

  /**
   * The meta object id for the '{@link cli.impl.cliTaskImpl <em>Task</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see cli.impl.cliTaskImpl
   * @see cli.impl.cliPackageImpl#getcliTask()
   * @generated
   */
  int CLI_TASK = 0;
  ...
  /**
   * Returns the meta object for class '{@link cli.cliTask <em>Task</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link cli.cliTask#getCommand <em>Command</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Command</em>'.
   * @see cli.cliTask#getCommand()
   * @see #getcliTask()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute list '{@link cli.cliTask#getArgument <em>Argument</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Argument</em>'.
   * @see cli.cliTask#getArgument()
   * @see #getcliTask()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link cli.cliTask#getPriority <em>Priority</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Priority</em>'.
   * @see cli.cliTask#getPriority()
   * @see #getcliTask()
   * @generated
   */
  ...
  {
    /**
     * The meta object literal for the '{@link cli.impl.cliTaskImpl <em>Task</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see cli.impl.cliTaskImpl
     * @see cli.impl.cliPackageImpl#getcliTask()
