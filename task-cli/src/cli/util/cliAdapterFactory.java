...
public class cliAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected cliSwitch<Adapter> modelSwitch = new cliSwitch<Adapter>()
    {
      @Override
      public Adapter casecliTask(cliTask object)
      {
        return createcliTaskAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link cli.cliTask <em>Task</em>}'.
   * <!-- begin-user-doc -->
